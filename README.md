...
![Регистрация и логин](screenshot1.jpg)

### 2. Главное меню с выбранными параметрами
![Выбор корабля, команды, маршрута](screenshot2.jpg)
![Выбор корабля, команды, маршрута](screenshot3.jpg)

### 3. Результат рейда
![Результат симуляции](screenshot3.jpg)
